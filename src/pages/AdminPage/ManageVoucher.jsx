...
const ManageVoucher = () => {
    ...
    const validateForm = () => {
        ...
        if (!newDiscount.discountPercentage || isNaN(newDiscount.discountPercentage) || 
            newDiscount.discountPercentage <= 0 || newDiscount.discountPercentage > 100) {
    ...
    const handleCreate = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:8080/api/discounts', newDiscount);
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await axios.put(`http://localhost:8080/api/discounts/${editingId}`, newDiscount);
            setDiscounts(discounts.map(d => d.id === editingId ? response.data : d));
            resetForm();
        } catch (error) {
